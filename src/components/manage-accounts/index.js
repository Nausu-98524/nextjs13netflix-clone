...
const ManageAccounts = () => {
  ...
  const [showDeleteIcon, setShowDeletIcon] = useState(false);
      ...
      <div className="flex justify-center flex-col items-center">
        ...
        <ul className="flex p-0 my-[25px]">
          {accounts && accounts.length
            ? accounts.map((item) => (
                <li
                  className="max-w-[200px] w-[155px] cursor-pointer flex flex-col items-center min-w-[200px]"
                  key={item._id}
                  onClick={
                  ...
                  <div className="relative">
                    ...
                    {showDeleteIcon ? (
                      <div
                        ...
                        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 x-10 cursor-pointer"
                      >
        ...
        <div className="text-center">
          <span
            onClick={() => setShowDeletIcon(!showDeleteIcon)}
